...
st.header('Target')
st.write('The target of this EDA is to draw conclusions about the factors that lead to happiness in various regions across the globe. The information and visualizations provided are based on the "World Happiness Data Set" as of 2021.  This will be done through the use of comprehensive charts, tables, and maps that will paint an overall picture of the given data set.')
# Data Exploration
